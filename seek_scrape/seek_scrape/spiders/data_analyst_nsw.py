'''
DSI14 - Project 4
Scrapy spider to scrap DATA ANALYST roles from Seek -- V02
Built from DS v03
'''
...
class SeekSpider(scrapy.Spider):
    name = "data_analyst_nsw"             #Spider name
    allowed_domains = ["seek.com.au"]       # ??

    # seed with the Seek landing site for DATA SCIENTIST jobs - NB will need to mod if looking for dif roles
    start_urls = ['https://www.seek.com.au/data-analyst-jobs/in-New-South-Wales-NSW']
